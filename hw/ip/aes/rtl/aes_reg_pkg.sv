...
package aes_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    aes_reg2hw_alert_test_reg_t alert_test; // [971:968]
    aes_reg2hw_key_share0_mreg_t [7:0] key_share0; // [967:704]
    aes_reg2hw_key_share1_mreg_t [7:0] key_share1; // [703:440]
    aes_reg2hw_iv_mreg_t [3:0] iv; // [439:308]
    aes_reg2hw_data_in_mreg_t [3:0] data_in; // [307:176]
    aes_reg2hw_data_out_mreg_t [3:0] data_out; // [175:44]
    aes_reg2hw_ctrl_shadowed_reg_t ctrl_shadowed; // [43:22]
    aes_reg2hw_ctrl_aux_shadowed_reg_t ctrl_aux_shadowed; // [21:20]
    aes_reg2hw_trigger_reg_t trigger; // [19:16]
    aes_reg2hw_status_reg_t status; // [15:14]
    aes_reg2hw_ctrl_gcm_shadowed_reg_t ctrl_gcm_shadowed; // [13:0]
  } aes_reg2hw_t;

  // HW -> register type
  typedef struct packed {
    aes_hw2reg_key_share0_mreg_t [7:0] key_share0; // [949:694]
    aes_hw2reg_key_share1_mreg_t [7:0] key_share1; // [693:438]
    aes_hw2reg_iv_mreg_t [3:0] iv; // [437:310]
    aes_hw2reg_data_in_mreg_t [3:0] data_in; // [309:178]
    aes_hw2reg_data_out_mreg_t [3:0] data_out; // [177:50]
    aes_hw2reg_ctrl_shadowed_reg_t ctrl_shadowed; // [49:34]
    aes_hw2reg_trigger_reg_t trigger; // [33:26]
    aes_hw2reg_status_reg_t status; // [25:12]
    aes_hw2reg_ctrl_gcm_shadowed_reg_t ctrl_gcm_shadowed; // [11:0]
  } aes_hw2reg_t;
  ...
  parameter logic [12:0] AES_CTRL_GCM_SHADOWED_RESVAL = 13'h 1001;
  parameter logic [6:0] AES_CTRL_GCM_SHADOWED_PHASE_RESVAL = 7'h 1;
