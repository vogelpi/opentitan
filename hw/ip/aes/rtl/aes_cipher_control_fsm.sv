  ...
  always_comb begin : aes_cipher_ctrl_fsm
    ...
    unique case (aes_cipher_ctrl_cs)
      ...
      CIPHER_CTRL_IDLE: begin
        ...
        // Control full key register mux. Note that from an SCA point of view, it is of advantage
        // to drive this signal whenever idle to avoid potential SCA leakage upon loading the
        // initial full key.
