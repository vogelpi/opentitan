...
module aes_reg_top (
  ...
  logic [6:0] ctrl_gcm_shadowed_phase_qs;
  logic [6:0] ctrl_gcm_shadowed_phase_wd;
  ...
  assign ctrl_gcm_shadowed_phase_wd = reg_wdata[6:0];

  assign ctrl_gcm_shadowed_num_valid_bytes_wd = reg_wdata[12:8];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[34]: begin
        reg_rdata_next[6:0] = ctrl_gcm_shadowed_phase_qs;
        reg_rdata_next[12:8] = ctrl_gcm_shadowed_num_valid_bytes_qs;
      end
