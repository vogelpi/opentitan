      ...
      CTRL_GHASH_READY: begin
        ...
        if (cipher_crypt_i) begin
          if (doing_gcm_hsk || doing_gcm_s || doing_gcm_txt) begin
            ...
            // We send the valid in the next clock cycle. Doing this check here, allows to decouple
            // the valid from the ready.
            if (ghash_in_ready_i) begin
          ...
          // We have work for the GHASH block, perform handshake.
          ghash_in_valid_o = 1'b1;
          if (ghash_in_ready_i) begin
