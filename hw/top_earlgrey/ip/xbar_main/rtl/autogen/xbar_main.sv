...
module xbar_main (
  ...
  tl_h2d_t tl_s1n_30_ds_h2d [22];
  tl_d2h_t tl_s1n_30_ds_d2h [22];
  ...
  tl_h2d_t tl_s1n_53_ds_h2d [22];
  tl_d2h_t tl_s1n_53_ds_d2h [22];

  // Create steering signal
  logic [4:0] dev_sel_s1n_53;
  ...
  assign tl_sm1_32_us_h2d[0] = tl_s1n_30_ds_h2d[3];
  assign tl_s1n_30_ds_d2h[3] = tl_sm1_32_us_d2h[0];

  assign tl_sm1_28_us_h2d[1] = tl_s1n_30_ds_h2d[4];
  assign tl_s1n_30_ds_d2h[4] = tl_sm1_28_us_d2h[1];

  assign tl_sm1_34_us_h2d[0] = tl_s1n_30_ds_h2d[5];
  assign tl_s1n_30_ds_d2h[5] = tl_sm1_34_us_d2h[0];

  assign tl_sm1_36_us_h2d[0] = tl_s1n_30_ds_h2d[6];
  assign tl_s1n_30_ds_d2h[6] = tl_sm1_36_us_d2h[0];

  assign tl_sm1_38_us_h2d[0] = tl_s1n_30_ds_h2d[7];
  assign tl_s1n_30_ds_d2h[7] = tl_sm1_38_us_d2h[0];

  assign tl_sm1_40_us_h2d[0] = tl_s1n_30_ds_h2d[8];
  assign tl_s1n_30_ds_d2h[8] = tl_sm1_40_us_d2h[0];

  assign tl_sm1_41_us_h2d[0] = tl_s1n_30_ds_h2d[9];
  assign tl_s1n_30_ds_d2h[9] = tl_sm1_41_us_d2h[0];

  assign tl_sm1_42_us_h2d[0] = tl_s1n_30_ds_h2d[10];
  assign tl_s1n_30_ds_d2h[10] = tl_sm1_42_us_d2h[0];

  assign tl_sm1_29_us_h2d[1] = tl_s1n_30_ds_h2d[11];
  assign tl_s1n_30_ds_d2h[11] = tl_sm1_29_us_d2h[1];

  assign tl_sm1_43_us_h2d[0] = tl_s1n_30_ds_h2d[12];
  assign tl_s1n_30_ds_d2h[12] = tl_sm1_43_us_d2h[0];

  assign tl_sm1_44_us_h2d[0] = tl_s1n_30_ds_h2d[13];
  assign tl_s1n_30_ds_d2h[13] = tl_sm1_44_us_d2h[0];

  assign tl_sm1_45_us_h2d[0] = tl_s1n_30_ds_h2d[14];
  assign tl_s1n_30_ds_d2h[14] = tl_sm1_45_us_d2h[0];

  assign tl_sm1_46_us_h2d[0] = tl_s1n_30_ds_h2d[15];
  assign tl_s1n_30_ds_d2h[15] = tl_sm1_46_us_d2h[0];

  assign tl_sm1_47_us_h2d[0] = tl_s1n_30_ds_h2d[16];
  assign tl_s1n_30_ds_d2h[16] = tl_sm1_47_us_d2h[0];

  assign tl_sm1_48_us_h2d[0] = tl_s1n_30_ds_h2d[17];
  assign tl_s1n_30_ds_d2h[17] = tl_sm1_48_us_d2h[0];

  assign tl_sm1_49_us_h2d[0] = tl_s1n_30_ds_h2d[18];
  assign tl_s1n_30_ds_d2h[18] = tl_sm1_49_us_d2h[0];

  assign tl_sm1_50_us_h2d[0] = tl_s1n_30_ds_h2d[19];
  assign tl_s1n_30_ds_d2h[19] = tl_sm1_50_us_d2h[0];

  assign tl_sm1_51_us_h2d[0] = tl_s1n_30_ds_h2d[20];
  assign tl_s1n_30_ds_d2h[20] = tl_sm1_51_us_d2h[0];

  assign tl_sm1_52_us_h2d[0] = tl_s1n_30_ds_h2d[21];
  assign tl_s1n_30_ds_d2h[21] = tl_sm1_52_us_d2h[0];

  assign tl_sm1_26_us_h2d[2] = tl_s1n_53_ds_h2d[0];
  assign tl_s1n_53_ds_d2h[0] = tl_sm1_26_us_d2h[2];

  assign tl_sm1_31_us_h2d[1] = tl_s1n_53_ds_h2d[1];
  assign tl_s1n_53_ds_d2h[1] = tl_sm1_31_us_d2h[1];

  assign tl_sm1_27_us_h2d[2] = tl_s1n_53_ds_h2d[2];
  assign tl_s1n_53_ds_d2h[2] = tl_sm1_27_us_d2h[2];

  assign tl_sm1_32_us_h2d[1] = tl_s1n_53_ds_h2d[3];
  assign tl_s1n_53_ds_d2h[3] = tl_sm1_32_us_d2h[1];

  assign tl_sm1_28_us_h2d[2] = tl_s1n_53_ds_h2d[4];
  assign tl_s1n_53_ds_d2h[4] = tl_sm1_28_us_d2h[2];

  assign tl_sm1_34_us_h2d[1] = tl_s1n_53_ds_h2d[5];
  assign tl_s1n_53_ds_d2h[5] = tl_sm1_34_us_d2h[1];

  assign tl_sm1_36_us_h2d[1] = tl_s1n_53_ds_h2d[6];
  assign tl_s1n_53_ds_d2h[6] = tl_sm1_36_us_d2h[1];

  assign tl_sm1_38_us_h2d[1] = tl_s1n_53_ds_h2d[7];
  assign tl_s1n_53_ds_d2h[7] = tl_sm1_38_us_d2h[1];

  assign tl_sm1_40_us_h2d[1] = tl_s1n_53_ds_h2d[8];
  assign tl_s1n_53_ds_d2h[8] = tl_sm1_40_us_d2h[1];

  assign tl_sm1_41_us_h2d[1] = tl_s1n_53_ds_h2d[9];
  assign tl_s1n_53_ds_d2h[9] = tl_sm1_41_us_d2h[1];

  assign tl_sm1_42_us_h2d[1] = tl_s1n_53_ds_h2d[10];
  assign tl_s1n_53_ds_d2h[10] = tl_sm1_42_us_d2h[1];

  assign tl_sm1_29_us_h2d[2] = tl_s1n_53_ds_h2d[11];
  assign tl_s1n_53_ds_d2h[11] = tl_sm1_29_us_d2h[2];

  assign tl_sm1_43_us_h2d[1] = tl_s1n_53_ds_h2d[12];
  assign tl_s1n_53_ds_d2h[12] = tl_sm1_43_us_d2h[1];

  assign tl_sm1_44_us_h2d[1] = tl_s1n_53_ds_h2d[13];
  assign tl_s1n_53_ds_d2h[13] = tl_sm1_44_us_d2h[1];

  assign tl_sm1_45_us_h2d[1] = tl_s1n_53_ds_h2d[14];
  assign tl_s1n_53_ds_d2h[14] = tl_sm1_45_us_d2h[1];

  assign tl_sm1_46_us_h2d[1] = tl_s1n_53_ds_h2d[15];
  assign tl_s1n_53_ds_d2h[15] = tl_sm1_46_us_d2h[1];

  assign tl_sm1_47_us_h2d[1] = tl_s1n_53_ds_h2d[16];
  assign tl_s1n_53_ds_d2h[16] = tl_sm1_47_us_d2h[1];

  assign tl_sm1_48_us_h2d[1] = tl_s1n_53_ds_h2d[17];
  assign tl_s1n_53_ds_d2h[17] = tl_sm1_48_us_d2h[1];

  assign tl_sm1_49_us_h2d[1] = tl_s1n_53_ds_h2d[18];
  assign tl_s1n_53_ds_d2h[18] = tl_sm1_49_us_d2h[1];

  assign tl_sm1_50_us_h2d[1] = tl_s1n_53_ds_h2d[19];
  assign tl_s1n_53_ds_d2h[19] = tl_sm1_50_us_d2h[1];

  assign tl_sm1_51_us_h2d[1] = tl_s1n_53_ds_h2d[20];
  assign tl_s1n_53_ds_d2h[20] = tl_sm1_51_us_d2h[1];

  assign tl_sm1_52_us_h2d[1] = tl_s1n_53_ds_h2d[21];
  assign tl_s1n_53_ds_d2h[21] = tl_sm1_52_us_d2h[1];

  assign tl_s1n_25_us_h2d = tl_rv_core_ibex__corei_i;
  assign tl_rv_core_ibex__corei_o = tl_s1n_25_us_d2h;

  assign tl_rom_ctrl__rom_o = tl_sm1_26_ds_h2d;
  assign tl_sm1_26_ds_d2h = tl_rom_ctrl__rom_i;

  assign tl_rv_dm__mem_o = tl_sm1_27_ds_h2d;
  assign tl_sm1_27_ds_d2h = tl_rv_dm__mem_i;

  assign tl_sram_ctrl_main__ram_o = tl_sm1_28_ds_h2d;
  assign tl_sm1_28_ds_d2h = tl_sram_ctrl_main__ram_i;

  assign tl_flash_ctrl__mem_o = tl_sm1_29_ds_h2d;
  assign tl_sm1_29_ds_d2h = tl_flash_ctrl__mem_i;

  assign tl_s1n_30_us_h2d = tl_rv_core_ibex__cored_i;
  assign tl_rv_core_ibex__cored_o = tl_s1n_30_us_d2h;

  assign tl_rom_ctrl__regs_o = tl_sm1_31_ds_h2d;
  assign tl_sm1_31_ds_d2h = tl_rom_ctrl__regs_i;

  assign tl_rv_dm__regs_o = tl_sm1_32_ds_h2d;
  assign tl_sm1_32_ds_d2h = tl_rv_dm__regs_i;

  assign tl_peri_o = tl_asf_33_ds_h2d;
  assign tl_asf_33_ds_d2h = tl_peri_i;

  assign tl_asf_33_us_h2d = tl_sm1_34_ds_h2d;
  assign tl_sm1_34_ds_d2h = tl_asf_33_us_d2h;

  assign tl_spi_host0_o = tl_asf_35_ds_h2d;
  assign tl_asf_35_ds_d2h = tl_spi_host0_i;
  ...
  assign tl_usbdev_o = tl_asf_39_ds_h2d;
  assign tl_asf_39_ds_d2h = tl_usbdev_i;

  assign tl_asf_39_us_h2d = tl_sm1_40_ds_h2d;
  assign tl_sm1_40_ds_d2h = tl_asf_39_us_d2h;

  assign tl_flash_ctrl__core_o = tl_sm1_41_ds_h2d;
  assign tl_sm1_41_ds_d2h = tl_flash_ctrl__core_i;

  assign tl_flash_ctrl__prim_o = tl_sm1_42_ds_h2d;
  assign tl_sm1_42_ds_d2h = tl_flash_ctrl__prim_i;

  assign tl_entropy_src_o = tl_sm1_43_ds_h2d;
  assign tl_sm1_43_ds_d2h = tl_entropy_src_i;

  assign tl_csrng_o = tl_sm1_44_ds_h2d;
  assign tl_sm1_44_ds_d2h = tl_csrng_i;

  assign tl_edn0_o = tl_sm1_45_ds_h2d;
  assign tl_sm1_45_ds_d2h = tl_edn0_i;

  assign tl_edn1_o = tl_sm1_46_ds_h2d;
  assign tl_sm1_46_ds_d2h = tl_edn1_i;

  assign tl_rv_plic_o = tl_sm1_47_ds_h2d;
  assign tl_sm1_47_ds_d2h = tl_rv_plic_i;

  assign tl_otbn_o = tl_sm1_48_ds_h2d;
  assign tl_sm1_48_ds_d2h = tl_otbn_i;

  assign tl_keymgr_o = tl_sm1_49_ds_h2d;
  assign tl_sm1_49_ds_d2h = tl_keymgr_i;

  assign tl_kmac_o = tl_sm1_50_ds_h2d;
  assign tl_sm1_50_ds_d2h = tl_kmac_i;

  assign tl_sram_ctrl_main__regs_o = tl_sm1_51_ds_h2d;
  assign tl_sm1_51_ds_d2h = tl_sram_ctrl_main__regs_i;

  assign tl_rv_core_ibex__cfg_o = tl_sm1_52_ds_h2d;
  assign tl_sm1_52_ds_d2h = tl_rv_core_ibex__cfg_i;

  assign tl_s1n_53_us_h2d = tl_rv_dm__sba_i;
  assign tl_rv_dm__sba_o = tl_s1n_53_us_d2h;
  ...
  always_comb begin
    ...
    if ((tl_s1n_53_us_h2d.a_address &
      ...
      ((tl_s1n_53_us_h2d.a_address & ~(ADDR_MASK_PERI[0])) == ADDR_SPACE_PERI[0]) ||
      ((tl_s1n_53_us_h2d.a_address & ~(ADDR_MASK_PERI[1])) == ADDR_SPACE_PERI[1])
    ) begin
      dev_sel_s1n_53 = 5'd5;
      ...
      dev_sel_s1n_53 = 5'd9;
                  ...
                  ~(ADDR_MASK_FLASH_CTRL__PRIM)) == ADDR_SPACE_FLASH_CTRL__PRIM) begin
      dev_sel_s1n_53 = 5'd10;

    end else if ((tl_s1n_53_us_h2d.a_address &
                  ~(ADDR_MASK_FLASH_CTRL__MEM)) == ADDR_SPACE_FLASH_CTRL__MEM) begin
      dev_sel_s1n_53 = 5'd11;

    end else if ((tl_s1n_53_us_h2d.a_address &
                  ~(ADDR_MASK_ENTROPY_SRC)) == ADDR_SPACE_ENTROPY_SRC) begin
      dev_sel_s1n_53 = 5'd12;

    end else if ((tl_s1n_53_us_h2d.a_address &
                  ~(ADDR_MASK_CSRNG)) == ADDR_SPACE_CSRNG) begin
      dev_sel_s1n_53 = 5'd13;

    end else if ((tl_s1n_53_us_h2d.a_address &
                  ~(ADDR_MASK_EDN0)) == ADDR_SPACE_EDN0) begin
      dev_sel_s1n_53 = 5'd14;

    end else if ((tl_s1n_53_us_h2d.a_address &
                  ~(ADDR_MASK_EDN1)) == ADDR_SPACE_EDN1) begin
      dev_sel_s1n_53 = 5'd15;

    end else if ((tl_s1n_53_us_h2d.a_address &
                  ~(ADDR_MASK_RV_PLIC)) == ADDR_SPACE_RV_PLIC) begin
      dev_sel_s1n_53 = 5'd16;

    end else if ((tl_s1n_53_us_h2d.a_address &
                  ~(ADDR_MASK_OTBN)) == ADDR_SPACE_OTBN) begin
      dev_sel_s1n_53 = 5'd17;

    end else if ((tl_s1n_53_us_h2d.a_address &
                  ~(ADDR_MASK_KEYMGR)) == ADDR_SPACE_KEYMGR) begin
      dev_sel_s1n_53 = 5'd18;

    end else if ((tl_s1n_53_us_h2d.a_address &
                  ~(ADDR_MASK_KMAC)) == ADDR_SPACE_KMAC) begin
      dev_sel_s1n_53 = 5'd19;

    end else if ((tl_s1n_53_us_h2d.a_address &
                  ~(ADDR_MASK_SRAM_CTRL_MAIN__REGS)) == ADDR_SPACE_SRAM_CTRL_MAIN__REGS) begin
      dev_sel_s1n_53 = 5'd20;

    end else if ((tl_s1n_53_us_h2d.a_address &
                  ~(ADDR_MASK_RV_CORE_IBEX__CFG)) == ADDR_SPACE_RV_CORE_IBEX__CFG) begin
      dev_sel_s1n_53 = 5'd21;
end
  end
