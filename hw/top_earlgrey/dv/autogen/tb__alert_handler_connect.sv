...
assign alert_if[43].alert_tx = `CHIP_HIER.u_kmac.alert_tx_o[1];
assign alert_if[44].alert_tx = `CHIP_HIER.u_otbn.alert_tx_o[0];
assign alert_if[45].alert_tx = `CHIP_HIER.u_otbn.alert_tx_o[1];
...
assign alert_if[49].alert_tx = `CHIP_HIER.u_csrng.alert_tx_o[1];
